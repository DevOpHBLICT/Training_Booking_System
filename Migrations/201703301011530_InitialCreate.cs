namespace Cascadingdropdownlist.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        FromHours = c.Int(nullable: false),
                        FromMinutes = c.Int(nullable: false),
                        ToHours = c.Int(nullable: false),
                        ToMinutes = c.Int(nullable: false),
                ...
                c => new
                    {
                        ...
                        Course_Dates_CourseID = c.Int(),
                        Student_ID = c.Int(),
                    })
                .PrimaryKey(t => t.CourseID)
                .ForeignKey("dbo.Course_Dates", t => t.Course_Dates_CourseID)
                .ForeignKey("dbo.Person", t => t.Student_ID)
                .Index(t => t.Course_Dates_CourseID)
            ...
            CreateTable(
                ...
                c => new
                    {
                        DF = c.DateTime(nullable: false),
                        Course_DatesID = c.Int(nullable: false),
                        Dept = c.String(),
                        Duration = c.Int(nullable: false),
                ...
                c => new
                    {
                        ...
                        Course_Dates_CourseID = c.Int(nullable: false),
                    })
                .PrimaryKey(t => new { t.Department_DepartmentID, t.Course_Dates_CourseID })
                .ForeignKey("dbo.Department", t => t.Department_DepartmentID, cascadeDelete: true)
                .ForeignKey("dbo.Course_Dates", t => t.Course_Dates_CourseID, cascadeDelete: true)
        ...
        public override void Down()
        {
            ...
            DropIndex("dbo.DepartmentCourse_Dates", new[] { "Course_Dates_CourseID" });
            ...
            DropIndex("dbo.Course", new[] { "Course_Dates_CourseID" });
